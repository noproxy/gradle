...
/**
 * A IvyPublisher that filter all the invalid artifacts whose optional is true.
 */
public class FilteringOptionalIvyPublisher implements IvyPublisher {
    private final IvyPublisher delegate;

    public FilteringOptionalIvyPublisher(IvyPublisher delegate) {
