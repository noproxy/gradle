...
class MavenPublishOptionalIntegTest extends AbstractMavenPublishIntegTest {
...
"""
    ...
    def "skip non-existing optional artifacts while publishing"() {
        server.start()
...
"""
    ...
    def "existing optional artifact can be published"() {
        server.start()
