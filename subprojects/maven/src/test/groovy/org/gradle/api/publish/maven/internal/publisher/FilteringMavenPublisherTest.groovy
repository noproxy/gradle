...
class FilteringMavenPublisherTest extends Specification {
    ...
    def publisher = new FilteringOptionalMavenPublisher(delegate)
    ...
    def "delegates accept the same properties except allArtifacts"() {
        ...
        1 * publication.mainArtifact.optional >> false
        _ * publication.pomArtifact.optional >> false
        0 * _._
    }
    ...
    private def artifact(boolean optional, boolean exist) {
